...
public:
    ...
    void apply(const std::vector<Slic3r::RGBA> &ori_colors,
               std::vector<Slic3r::RGBA> &      cluster_results,
    ...
    // }
    // void apply_aplha(cv::TMat &ori_image, cv::Mat &new_image, int num_cluster, int color_space)
    // {
    //     // cout << " *** DoAlpha *** " << endl;
